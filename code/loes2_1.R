...
################ Säulendiagramme für X1 "laufendes Konto" ######################

X1.Anteile <- matrix(nrow=3, ncol=2, 
                     data=c(0.45, 0.397, 0.153, 0.199, 0.302, 0.497), 
                     byrow=FALSE)
...
############ Säulendiagramme für X4 "Rückzahlung früherer Kredite" #############

X4.Anteile <- matrix(nrow=2, ncol=2, data=c(0.8233,0.1766,0.9485,0.0515), 
                     byrow=FALSE)
...
################## Säulendiagramme für X5 "Verwendungszweck" ###################

X5.Anteile <- matrix(nrow=2, ncol=2, data=c(0.5753,0.4247,0.6929,0.3071), 
                     byrow=FALSE)
...
################ Histogramme für X3 "Kredithöhe in Euro" ####################### 
...
barplot(h.Y1,klassenbreiten, space=0,col="white",
        ylim=c(0,3.5), axes=F, 
        xlab="Kredithöhe", ylab="Höhe*10000", main="Y = 1")
...
barplot(h.Y0,klassenbreiten, space=0,col="white",
        ylim=c(0,4.0), axes=F, 
        xlab="Kredithöhe", ylab="Höhe*10000", main="Y = 0")
axis(1, at=intervalle)
